...
if (numVisits !== 0) {
	...
	visitsDisplay.textContent = `First visit. Welcome!`;
}
...
// 💡A client can view the localStorage data using the Applications panel 
//in the browsers's DevTools - check it out on any major site.